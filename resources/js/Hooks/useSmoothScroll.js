...
export function useSmoothScroll() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ["home", "features", "stories", "pricing", "faqs"];
  ...
  useEffect(() => {
    const handleHashChange = () => {
      ...
      if (hash && ["home", "features", "stories", "pricing", "faqs"].includes(hash)) {
    ...
    if (
      initialHash &&
      ["home", "features", "stories", "pricing", "faqs"].includes(initialHash)
    ) {
