      ...
      {menuIsOpen && (
        ...
        >
          <div className="flex flex-col py-1.5">
            <Link href={profileRoute} className="flex items-center gap-2 px-2 py-1.5 text-sm font-medium text-neutral-800 underline-offset-2 hover:bg-orange-500/5 hover:text-black focus-visible:underline focus:outline-hidden dark:text-neutral-300 dark:hover:bg-orange-400/5 dark:hover:text-neutral-100" role="menuitem">
          ...
          {impersonate_admin_id && (
            <div className="flex flex-col py-1.5">
              <button
                ...
                className="flex items-center gap-2 px-2 py-1.5 text-sm font-medium text-orange-800 underline-offset-2 hover:bg-orange-500/10 hover:text-orange-900 focus-visible:underline focus:outline-hidden dark:text-orange-300 dark:hover:bg-orange-400/10 dark:hover:text-orange-100"
                role="menuitem"
              >
