  ...
  return (
    <div className="flex flex-col">
      <button
        ...
        className={`flex items-center justify-between rounded-xl gap-2 px-2 py-1.5 text-sm font-medium underline-offset-2 focus:outline-hidden focus-visible:underline ${isExpanded || isAnySubmenuActive || isParentRouteActive ? 'text-black bg-orange-500/10 dark:text-neutral-100 dark:bg-orange-400/10' : 'text-neutral-800 hover:bg-orange-500/5 hover:text-black dark:text-neutral-300 dark:hover:bg-orange-400/5 dark:hover:text-neutral-100'}`}
      >
