...
import StaticPagesCategoriesTable from './Partials/Tables/StaticPagesCategoriesTable';
import { useTrans } from '@/Hooks/useTrans';

export default function StaticPagesCategories({ auth, categories, queryParams = null }) {
  ...
  return (
    <AppLayout user={auth.user}>
      <Head title={t('static_page_categories_management')} />
          ...
          <div className="p-4 text-neutral-900 dark:text-neutral-100">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-bold leading-tight text-neutral-900 dark:text-neutral-100 flex items-center gap-2">
                <i className="fa-solid fa-folder text-blue-500"></i> {t('static_page_categories')}
              </h2>
              <PrimaryButton
                type="button"
            ...
            <StaticPagesCategoriesTable categories={categories} onEdit={toggleEditModal} />
          </div>
        </div>
      </div>
