        ...
        <div className="p-6 min-w-[300px] lg:min-w-[400px]">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-lg bg-orange-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-orange-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2 dark:bg-orange-700 dark:hover:bg-orange-600 dark:focus-visible:ring-orange-500"
            >
